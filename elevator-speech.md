...
Yolov5를 이용한 풍경 classification 및 객체 detection을 통해 사진에 객체 tag를 붙이고, MTCNN과 Arcface를 이용한 얼굴 식별을 통해 사진에 얼굴 tag를 붙입니다. 결과 tag를 통해 사진은 폴더로 분류되고, 그렇게 분류된 폴더를 이용해 각 사용자는 원하는 사진만 손쉽게 다운로드 받을 수 있습니다.
