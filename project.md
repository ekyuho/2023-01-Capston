...
## 산출물
1. 다양한 게시판 서비스 설계서
 1. 기본, 고도화, 어드민 게시판 기획, 설계
1. 게시판 프론트앤드 시스템
 1. MVC 형태로 구분된 게시판 코드 작성
1. 게시판 백앤드 시스템
 1. 스프링 프레임워크 기반 코드 작성
 1. 데이터베이스 설계 및 산출물
1. 어드민 서비스 데모 사이트 2종
 1. NCP 기반 데모사이트 1식
 1. 온프레미스 환경 데모사이트 1식
...
## 산출물
1. REST API 설계 문서작성
 1. 외부 API 및 공공데이터 활용 내용
 1. 병원 찾기 서비스 구현을 위한 API내용
1. 프론트앤드 시스템 개발
 1. 병원 찾기 서비스 UI/UX 설계 및 구현
1. 백앤드 시스템 개발
 1. 스프링 프레임워크 기반 코드 작성
 1. 데이터베이스 설계 및 산출물
1. 데모용 클라우드 기반 시스템 구축
 1. 서버리스 기반 시스템 구축 및 제출
 1. 관리형 RDB 형태 서비스로 구축
## 평가절차
